package net.collegeman.rsync.test;
...
public class ClientTests extends TestCase {
	...
	public void setUp() {
		...
		try {
			FileUtils.copyDirectory(new File("linux-kernel/2.0.10"), dest, true);
			FileUtils.copyDirectory(new File("linux-kernel/2.0.9"), source, true);
		} catch (IOException e) {
